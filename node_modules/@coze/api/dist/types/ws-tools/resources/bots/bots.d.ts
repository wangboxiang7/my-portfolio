...
export declare class Bots extends APIResource {
     ...
     */
    listNew(params: ListBotNewReq, options?: RequestOptions): Promise<ListBotNewData>;
    /**
     ...
     * @returns
     */
    retrieveNew(botId: string, params?: RetrieveBotNewReq, options?: RequestOptions): Promise<BotInfo>;
}
