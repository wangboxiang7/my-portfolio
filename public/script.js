...
if (canvas && canvas.getContext) {
  ...
  const resizeCanvas = () => {
    ...
    const homeHeight = homeSection?.offsetHeight || window.innerHeight || 0;
    height = canvas.height = homeHeight;
  };
  ...
  console.warn('Particles canvas not found; skip animation init.');
}
